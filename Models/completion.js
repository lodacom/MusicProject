...
{
  _documentForm=form;
  _inputField=field;//récupération de la valeur insérée par l'utilisateur
  _submitButton=submit;
  _inputField.autocomplete="off";
  creeAutocompletionDiv();
  _currentInputFieldValue=_inputField.value;//.value pour la valeur
...
var _adresseRecherche = "../../Models/recherche.php" //l'adresse à interroger pour trouver les suggestions
